...
public class Book {
	...
	public String toString() {
		return "Book [id=" + id + ", sku=" + sku + ", name=" + name + ", description=" + description + ", unitPrice="
				...
				+ ", createdOn=" + createdOn + ", updatedOn=" + updatedOn + ", category=" + category + ", getId()="
				+ getId() + ", getSku()=" + getSku() + ", getName()=" + getName() + ", getDescription()="
				+ getDescription() + ", getUnitPrice()=" + getUnitPrice() + ", getImageUrl()=" + getImageUrl()
				+ ", isActive()=" + isActive() + ", getUnitsInStock()=" + getUnitsInStock() + ", getCreatedOn()="
				+ getCreatedOn() + ", getUpdatedOn()=" + getUpdatedOn() + ", getCategory()=" + getCategory()
